...
public class DragAndDrop {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//---------------------------
		 WebElement target1= driver.findElement(By.xpath("//li[@class='placeholder']/ancestor::ol[@id='amt7']"));
		 WebElement target2 = driver.findElement(By.xpath("//li[@class='placeholder']/ancestor::ol[@id='bank']"));
		 WebElement target3 = driver.findElement(By.xpath("//li[@class='placeholder']/ancestor::ol[@id='amt8']"));
		 WebElement target4 = driver.findElement(By.xpath("//li[@class='placeholder']/ancestor::ol[@id='loan']"));
